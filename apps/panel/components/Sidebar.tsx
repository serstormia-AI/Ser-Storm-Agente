      ...
      <div className="border-t border-slate-800 pt-4 space-y-2">
        {connectionStatus === 'connected' ? (
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-3 py-2.5 rounded-lg text-xs font-semibold bg-indigo-600/20 text-indigo-300 border border-indigo-500/40 hover:bg-indigo-600/30 transition-all shadow-md shadow-indigo-500/10"
          >
